...
/**
  ...
  */
final class XnioDirectByteBuf private[buffer](alloc: ByteBufAllocator, val initialCapacity: Int, maxCapacity: Int) extends UnpooledDirectByteBuf(alloc, initialCapacity, maxCapacity) {
